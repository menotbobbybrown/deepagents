...
## [0.1.73](https://github.com/menotbobbybrown/deepagents/compare/deepagents-code==0.1.72...deepagents-code==0.1.73) (2026-09-21)
...
* **code:** condense status bar cwd from the middle, tail intact ([#6252](https://github.com/menotbobbybrown/deepagents/issues/6252)) ([f733893](https://github.com/menotbobbybrown/deepagents/commit/f7338933e5ebd6959820023efb66704d6ab8ce7f))
...
* **code:** move MCP onto FastMCP and `langchain.mcp` ([#5922](https://github.com/menotbobbybrown/deepagents/issues/5922)) ([0692ef1](https://github.com/menotbobbybrown/deepagents/commit/0692ef1550568a585afe48705d54a4aa07002697))
...
* **code:** show `read_file` arguments when expanded ([#6392](https://github.com/menotbobbybrown/deepagents/issues/6392)) ([902905f](https://github.com/menotbobbybrown/deepagents/commit/902905f2508fe74dc0ba13d857f502e8ddbc807e))
...
* **code:** align file and console debug log formatting ([#6426](https://github.com/menotbobbybrown/deepagents/issues/6426)) ([6c219d3](https://github.com/menotbobbybrown/deepagents/commit/6c219d3a39a869b55c5ec434acf76f84217eb002))
...
* **code:** anchor editable refresh to its checkout ([#6455](https://github.com/menotbobbybrown/deepagents/issues/6455)) ([a6d844d](https://github.com/menotbobbybrown/deepagents/commit/a6d844d47126bb905f30e76569110cd68294a0b3))
...
* **code:** keep absolute paths in normal input mode ([#6379](https://github.com/menotbobbybrown/deepagents/issues/6379)) ([141ce98](https://github.com/menotbobbybrown/deepagents/commit/141ce9851b876f733ef390ead3edbc509536a8e8))
...
* **code:** pin resumed history to newest message ([#6225](https://github.com/menotbobbybrown/deepagents/issues/6225)) ([9b5ca38](https://github.com/menotbobbybrown/deepagents/commit/9b5ca384ff727f16c4f66a13308170cfba899b97))
...
* **code:** replace composer with prompt search and prevent query feedback ([#6346](https://github.com/menotbobbybrown/deepagents/issues/6346)) ([a52ecea](https://github.com/menotbobbybrown/deepagents/commit/a52ecea1f4b159a5ec0c667c6d05e26ea701db30))
...
* **code:** scroll overflowing chat input pastes ([#6382](https://github.com/menotbobbybrown/deepagents/issues/6382)) ([b522fd4](https://github.com/menotbobbybrown/deepagents/commit/b522fd4a74b2349b25f3f1f630265f7e456430ee))
...
* **code:** silence non-media path decoder traces ([#6427](https://github.com/menotbobbybrown/deepagents/issues/6427)) ([3693e9d](https://github.com/menotbobbybrown/deepagents/commit/3693e9d01a94a4e881cbb5f92438adfec27cd77e))
...
* **code:** wrap debug logs before the scrollbar ([#6219](https://github.com/menotbobbybrown/deepagents/issues/6219)) ([ca7999a](https://github.com/menotbobbybrown/deepagents/commit/ca7999a8a9984e110a3b80d2e5f71dbe895f58ec))
...
* **code:** skip transcript scan on prompt submit ([#6402](https://github.com/menotbobbybrown/deepagents/issues/6402)) ([443d34b](https://github.com/menotbobbybrown/deepagents/commit/443d34bfde4f22cbc7f9ac71be766922a041e08c))
